...
import { IAboutContentData } from "./about.interface.js";
...
export class AboutService {
	public static async getAboutContent() {
	...
	public static async updateAboutContent(data: IAboutContentData) {
		let existing = await prisma.aboutContent.findFirst();
		if (!existing) {
			return await prisma.aboutContent.create({
				data: {
