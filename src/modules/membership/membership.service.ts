...
import { IMembershipContent } from "./membership.interface.js";
...
export class MembershipService {
	public static async getMembershipContent() {
	...
	public static async updateMembershipContent(data: IMembershipContent) {
		const pathwaysStr =
		...
		return await prisma.membershipContent.upsert({
			where: { id: "global" },
			update: {
